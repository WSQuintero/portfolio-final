...
function AnimatedSkillSection () {
  ...
  return (
    <div className='relative flex xl:flex-row flex-col justify-center items-center w-full h-full background-js mt-20' ref={skillSectionTwo}>
      ...
      <div className='relative mb-5 flex justify-center items-center w-full h-[300px] xl:h-full xl:w-[600px]'>
        <div className='absolute xl:left-0 top-0 xl:top-auto w-[50px] sm:w-[200px] h-[26px]' ref={observerLeft}></div>
        ...
        <div className='absolute xl:right-20 bottom-0 xl:bottom-auto w-[50px] sm:w-[200px] h-[26px]' ref={observerRight}></div>
        <div className='relative flex h-auto justify-center items-center mt-[16px] ml-[15px]' ref={elements}>
            ...
            <React.Fragment key={index}>
              {circlesIsActive && (
                <figure className='absolute w-[50px] h-[50px] xl:w-[80px] xl:h-[80px] rounded-[50%] flex justify-center items-center bg-gray-300 object-cover'>
                  <img src={url} alt={Object.keys(logos)[index]} className='w-[60%]' />
                </figure>
              )}
            </React.Fragment>
          ))}
